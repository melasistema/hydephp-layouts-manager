    ...
    */
    'components' => [
        'flowbite' => [
            'hero-sections' => [
                'default-jumbotron' => [
                    'view' => 'hyde-layouts-manager::components.flowbite.hero-sections.default-jumbotron',
                    'layouts' => [
                        'melasistema' => [
                        ...
                        'alternative' => [
                            'config' => [
                                ...
                                'settings' => [
                                    ...
                                    'padding' => 'py-8 px-4',
                                    'maxWidth' => 'max-w-screen-xl',
                                    'headingText' => 'Alternative Flowbite Hero Default',
                                    'subHeadingText' => 'Manage your layouts and reusable components with ease.',
                                    'headingTextSize' => [
                                        'default' => 'text-6xl',
                                        'md' => 'md:text-6xl',
