<article aria-label="Article" id="{{ $page->identifier }}" itemscope itemtype="https://schema.org/Article"
    ...
    <header aria-label="Header section" role="doc-pageheader">
        ...
        <div id="byline" aria-label="About the post" role="doc-introduction">
            @includeWhen(isset($page->date), 'hyde-layouts-manager::components.post.date')
            @includeWhen(isset($page->author), 'hyde-layouts-manager::components.post.author')
            @includeWhen(isset($page->category), 'hyde-layouts-manager::components.post.category')
        </div>
    </header>
    @includeWhen(isset($page->image), 'hyde-layouts-manager::components.post.image')
