                    ...
                    'styles' => [
                        'default' => [
                            'config' => [
                                'layout' => [
                                    ...
                                    'blackAndWhiteRandom' => false,  // New flag to control random black and white images
                                ],
                                'settings' => [
                                    'cols' => [
                        ...
                        'compact' => [
                            'config' => [
                                ...
                                'images' => [
                                    'gallery/hyde/compact-01.png',
                                    'gallery/hyde/compact-02.png',
                                    'gallery/hyde/compact-03.png',
                                ],
                            ]
                        ],
                    ],
